...
participant04.Q01 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q17-Act01-Data.csv", header=TRUE)
attach (participant04.Q01)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q01 <- participant04.Q01 %>% filter(!across(everything(), is.na)) %>% 
...
question01.Window <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Window. =="1")
fixations.Window.Q01 <-  sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Window.)
...
# AOI Question
question01.Question <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Question.=="1")
fixations.Question.Q01 <- sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Question.)
...
# AOI Answer
question01.Answer <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Answer.=="1")
fixations.Answer.Q01 <- sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Answer.)
...
# AOI Legend
question01.Legend <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Legend.=="1")
fixations.Legend.Q01 <- sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Legend.)
...
# AOI Buttons
question01.Buttons <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Buttons.=="1")
fixations.Buttons.Q01 <- sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.Buttons.)
...
# AOI FeatureModel
question01.FM <- question01 %>% filter(AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.FMAOI.=="1")
fixations.FM.Q01 <- sum(question01$AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.FMAOI.)
...
question01.Containing <- question01 %>% 
  filter(  AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.CAOI.5.=="1") 
...
question01.Navigating <- question01 %>% 
  filter(  AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q17.Act01.Snap...Q01.NAOI.2.=="1")
...
participant04.Q02 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q12-Act02-Data.csv", header=TRUE)
attach (participant04.Q02)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q02 <- participant04.Q02 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question02 <- curated04.Q02
...
# AOI Window - QNN for participant question
question02.Window <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Window. =="1")
fixations.Window.Q02 <-  sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Window.)
...
# AOI Question
question02.Question <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Question.=="1")
fixations.Question.Q02 <- sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Question.)
...
# AOI Answer
question02.Answer <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Answer.=="1")
fixations.Answer.Q02 <- sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Answer.)
...
# AOI Legend
question02.Legend <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Legend.=="1")
fixations.Legend.Q02 <- sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Legend.)
...
# AOI Buttons
question02.Buttons <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Buttons.=="1")
fixations.Buttons.Q02 <- sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.Buttons.)
...
# AOI FeatureModel
question02.FM <- question02 %>% filter(AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.FMAOI.=="1")
fixations.FM.Q02 <- sum(question02$AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.FMAOI.)
...
question02.Containing <- question02 %>% 
  filter(  AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.CAOI.3.=="1") 
...
question02.Navigating <- question02 %>% 
  filter(  AOI.hit..P04.TOI.Q12.Act02.Snap...Q02.NAOI.1.=="1")
...
participant04.Q03 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q15-Act03-Data.csv", header=TRUE)
attach (participant04.Q03)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q03 <- participant04.Q03 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question03 <- curated04.Q03
...
# AOI Window - QNN for participant question
question03.Window <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Window. =="1")
fixations.Window.Q03 <-  sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Window.)
...
# AOI Question
question03.Question <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Question.=="1")
fixations.Question.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Question.)
...
# AOI Answer
question03.Answer <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Answer.=="1")
fixations.Answer.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Answer.)
...
# AOI Legend
question03.Legend <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Legend.=="1")
fixations.Legend.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Legend.)
...
# AOI Buttons
question03.Buttons <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Buttons.=="1")
fixations.Buttons.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.Buttons.)
...
# AOI FeatureModel
question03.FM <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.FMAOI.=="1")
fixations.FM.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.FMAOI.)
...
question03.Containing <- question03 %>% 
  filter(  AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CAOI.4.=="1") 
...
# AOI CTC
question03.CTC <- question03 %>% filter(AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CTC.=="1")
fixations.CTC.Q03 <- sum(question03$AOI.hit..P04.TOI.Q15.Act03.Snap...Q03.CTC.)
...
participant04.Q04 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q03-Act04-Data.csv", header=TRUE)
attach (participant04.Q04)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q04 <- participant04.Q04 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question04 <- curated04.Q04
...
# AOI Window - QNN for participant question
question04.Window <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Window. =="1")
fixations.Window.Q04 <-  sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Window.)
...
# AOI Question
question04.Question <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Question.=="1")
fixations.Question.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Question.)
...
# AOI Answer
question04.Answer <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Answer.=="1")
fixations.Answer.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Answer.)
...
# AOI Legend
question04.Legend <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Legend.=="1")
fixations.Legend.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Legend.)
...
# AOI Buttons
question04.Buttons <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Buttons.=="1")
fixations.Buttons.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.Buttons.)
...
# AOI FeatureModel
question04.FM <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.FMAOI.=="1")
fixations.FM.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.FMAOI.)
...
question04.Containing <- question04 %>% 
  filter(  AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.CAOI.1.=="1") 
...
# AOI CTC
question04.CTC <- question04 %>% filter(AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.CTC.=="1")
fixations.CTC.Q04 <- sum(question04$AOI.hit..P04.TOI.Q03.Act04.Snap...Q04.CTC.)
...
participant04.Q05 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q01-Act05-Data.csv", header=TRUE)
attach (participant04.Q05)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q05 <- participant04.Q05 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question05 <- curated04.Q05
...
# AOI Window - QNN for participant question
question05.Window <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Window. =="1")
fixations.Window.Q05 <-  sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Window.)
...
# AOI Question
question05.Question <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Question.=="1")
fixations.Question.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Question.)
...
# AOI Answer
question05.Answer <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Answer.=="1")
fixations.Answer.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Answer.)
...
# AOI Legend
question05.Legend <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Legend.=="1")
fixations.Legend.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Legend.)
...
# AOI Buttons
question05.Buttons <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Buttons.=="1")
fixations.Buttons.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.Buttons.)
...
# AOI FeatureModel
question05.FM <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.FMAOI.=="1")
fixations.FM.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.FMAOI.)
...
question05.Containing <- question05 %>% 
  filter(  AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.CAOI.3.=="1") 
...
# AOI CTC
question05.CTC <- question05 %>% filter(AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.CTC.=="1")
fixations.CTC.Q05 <- sum(question05$AOI.hit..P04.TOI.Q01.Act05.Snap...Q05.CTC.)
...
participant04.Q06 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q02-Act06-Data.csv", header=TRUE)
attach (participant04.Q06)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q06 <- participant04.Q06 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question06 <- curated04.Q06
...
# AOI Window - QNN for participant question
question06.Window <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Window. =="1")
fixations.Window.Q06 <-  sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Window.)
...
# AOI Question
question06.Question <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Question.=="1")
fixations.Question.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Question.)
...
# AOI Answer
question06.Answer <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Answer.=="1")
fixations.Answer.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Answer.)
...
# AOI Legend
question06.Legend <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Legend.=="1")
fixations.Legend.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Legend.)
...
# AOI Buttons
question06.Buttons <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Buttons.=="1")
fixations.Buttons.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.Buttons.)
...
# AOI FeatureModel
question06.FM <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.FMAOI.=="1")
fixations.FM.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.FMAOI.)
...
question06.Containing <- question06 %>% 
  filter(  AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.CAOI.4.=="1") 
...
question06.Navigating <- question06 %>% 
  filter(  AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.NAOI.1.=="1")
...
# AOI CTC
question06.CTC <- question06 %>% filter(AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.CTC.=="1")
fixations.CTC.Q06 <- sum(question06$AOI.hit..P04.TOI.Q02.Act06.Snap...Q06.CTC.)
...
participant04.Q07 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q16-Act07-Data.csv", header=TRUE)
attach (participant04.Q07)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q07 <- participant04.Q07 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question07 <- curated04.Q07
...
# AOI Window - QNN for participant question
question07.Window <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Window. =="1")
fixations.Window.Q07 <-  sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Window.)
...
# AOI Question
question07.Question <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Question.=="1")
fixations.Question.Q07 <- sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Question.)
...
# AOI Answer
question07.Answer <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Answer.=="1")
fixations.Answer.Q07 <- sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Answer.)
...
# AOI Legend
question07.Legend <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Legend.=="1")
fixations.Legend.Q07 <- sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Legend.)
...
# AOI Buttons
question07.Buttons <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Buttons.=="1")
fixations.Buttons.Q07 <- sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.Buttons.)
...
# AOI FeatureModel
question07.FM <- question07 %>% filter(AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.FMAOI.=="1")
fixations.FM.Q07 <- sum(question07$AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.FMAOI.)
...
question07.Containing <- question07 %>% 
  filter(  AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q16.Act07.Snap...Q07.CAOI.4.=="1") 
...
participant04.Q08 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q11-Act08-Data.csv", header=TRUE)
attach (participant04.Q08)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q08 <- participant04.Q08 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question08 <- curated04.Q08
...
# AOI Window - QNN for participant question
question08.Window <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Window. =="1")
fixations.Window.Q08 <-  sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Window.)
...
# AOI Question
question08.Question <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Question.=="1")
fixations.Question.Q08 <- sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Question.)
...
# AOI Answer
question08.Answer <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Answer.=="1")
fixations.Answer.Q08 <- sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Answer.)
...
# AOI Legend
question08.Legend <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Legend.=="1")
fixations.Legend.Q08 <- sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Legend.)
...
# AOI Buttons
question08.Buttons <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Buttons.=="1")
fixations.Buttons.Q08 <- sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.Buttons.)
...
# AOI FeatureModel
question08.FM <- question08 %>% filter(AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.FMAOI.=="1")
fixations.FM.Q08 <- sum(question08$AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.FMAOI.)
...
question08.Containing <- question08 %>% 
  filter(  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.CAOI.6.=="1" |	      
  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.CAOI.7.=="1") 
...
question08.Navigating <- question08 %>% 
  filter(  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q11.Act08.Snap...Q08.NAOI.3.=="1")
...
participant04.Q09 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q05-Act09-Data.csv", header=TRUE)
attach (participant04.Q09)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q09 <- participant04.Q09 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question09 <- curated04.Q09
...
# AOI Window - QNN for participant question
question09.Window <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Window. =="1")
fixations.Window.Q09 <-  sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Window.)
...
# AOI Question
question09.Question <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Question.=="1")
fixations.Question.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Question.)
...
# AOI Answer
question09.Answer <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Answer.=="1")
fixations.Answer.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Answer.)
...
# AOI Legend
question09.Legend <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Legend.=="1")
fixations.Legend.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Legend.)
...
# AOI Buttons
question09.Buttons <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Buttons.=="1")
fixations.Buttons.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.Buttons.)
...
# AOI FeatureModel
question09.FM <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.FMAOI.=="1")
fixations.FM.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.FMAOI.)
...
question09.Containing <- question09 %>% 
  filter(  AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CAOI.4.=="1") 
...
# AOI CTC
question09.CTC <- question09 %>% filter(AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CTC.=="1")
fixations.CTC.Q09 <- sum(question09$AOI.hit..P04.TOI.Q05.Act09.Snap...Q09.CTC.)
...
participant04.Q10 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q07-Act10-Data.csv", header=TRUE)
attach (participant04.Q10)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q10 <- participant04.Q10 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question10 <- curated04.Q10
...
# AOI Window - QNN for participant question
question10.Window <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Window. =="1")
fixations.Window.Q10 <-  sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Window.)
...
# AOI Question
question10.Question <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Question.=="1")
fixations.Question.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Question.)
...
# AOI Answer
question10.Answer <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Answer.=="1")
fixations.Answer.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Answer.)
...
# AOI Legend
question10.Legend <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Legend.=="1")
fixations.Legend.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Legend.)
...
# AOI Buttons
question10.Buttons <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Buttons.=="1")
fixations.Buttons.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.Buttons.)
...
# AOI FeatureModel
question10.FM <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.FMAOI.=="1")
fixations.FM.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.FMAOI.)
...
question10.Containing <- question10 %>% 
  filter(  AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.CAOI.2.=="1") 
...
# AOI CTC
question10.CTC <- question10 %>% filter(AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.CTC.=="1")
fixations.CTC.Q10 <- sum(question10$AOI.hit..P04.TOI.Q07.Act10.Snap...Q10.CTC.)
...
participant04.Q11 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q19-Act11-Data.csv", header=TRUE)
attach (participant04.Q11)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q11 <- participant04.Q11 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question11 <- curated04.Q11
...
# AOI Window - QNN for participant question
question11.Window <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Window. =="1")
fixations.Window.Q11 <-  sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Window.)
...
# AOI Question
question11.Question <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Question.=="1")
fixations.Question.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Question.)
...
# AOI Answer
question11.Answer <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Answer.=="1")
fixations.Answer.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Answer.)
...
# AOI Legend
question11.Legend <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Legend.=="1")
fixations.Legend.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Legend.)
...
# AOI Buttons
question11.Buttons <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Buttons.=="1")
fixations.Buttons.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.Buttons.)
...
# AOI FeatureModel
question11.FM <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.FMAOI.=="1")
fixations.FM.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.FMAOI.)
...
question11.Containing <- question11 %>% 
  filter(  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CAOI.6.=="1" |	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CAOI.7.=="1" |	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CAOI.8.=="1") 
...
question11.Navigating <- question11 %>% 
  filter(  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.NAOI.4.=="1")
...
# AOI CTC
question11.CTC <- question11 %>% filter(AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CTC.=="1")
fixations.CTC.Q11 <- sum(question11$AOI.hit..P04.TOI.Q19.Act11.Snap...Q11.CTC.)
...
participant04.Q12 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q14-Act12-Data.csv", header=TRUE)
attach (participant04.Q12)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q12 <- participant04.Q12 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question12 <- curated04.Q12
...
# AOI Window - QNN for participant question
question12.Window <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Window. =="1")
fixations.Window.Q12 <-  sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Window.)
...
# AOI Question
question12.Question <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Question.=="1")
fixations.Question.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Question.)
...
# AOI Answer
question12.Answer <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Answer.=="1")
fixations.Answer.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Answer.)
...
# AOI Legend
question12.Legend <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Legend.=="1")
fixations.Legend.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Legend.)
...
# AOI Buttons
question12.Buttons <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Buttons.=="1")
fixations.Buttons.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.Buttons.)
...
# AOI FeatureModel
question12.FM <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.FMAOI.=="1")
fixations.FM.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.FMAOI.)
...
question12.Containing <- question12 %>% 
  filter(  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.CAOI.6.=="1") 
...
question12.Navigating <- question12 %>% 
  filter(  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.NAOI.3.=="1" | 	      
  AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.NAOI.4.=="1")
...
# AOI CTC
question12.CTC <- question12 %>% filter(AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.CTC.=="1")
fixations.CTC.Q12 <- sum(question12$AOI.hit..P04.TOI.Q14.Act12.Snap...Q12.CTC.)
...
participant04.Q13 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q18-Act13-Data.csv", header=TRUE)
attach (participant04.Q13)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q13 <- participant04.Q13 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question13 <- curated04.Q13
...
# AOI Window - QNN for participant question
question13.Window <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Window. =="1")
fixations.Window.Q13 <-  sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Window.)
...
# AOI Question
question13.Question <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Question.=="1")
fixations.Question.Q13 <- sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Question.)
...
# AOI Answer
question13.Answer <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Answer.=="1")
fixations.Answer.Q13 <- sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Answer.)
...
# AOI Legend
question13.Legend <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Legend.=="1")
fixations.Legend.Q13 <- sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Legend.)
...
# AOI Buttons
question13.Buttons <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Buttons.=="1")
fixations.Buttons.Q13 <- sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.Buttons.)
...
# AOI FeatureModel
question13.FM <- question13 %>% filter(AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.FMAOI.=="1")
fixations.FM.Q13 <- sum(question13$AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.FMAOI.)
...
question13.Containing <- question13 %>% 
  filter(  AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.CAOI.3.=="1") 
...
question13.Navigating <- question13 %>% 
  filter(  AOI.hit..P04.TOI.Q18.Act13.Snap...Q13.NAOI.1.=="1")
...
participant04.Q14 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q09-Act14-Data.csv", header=TRUE)
attach (participant04.Q14)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q14 <- participant04.Q14 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question14 <- curated04.Q14
...
# AOI Window - QNN for participant question
question14.Window <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Window. =="1")
fixations.Window.Q14 <-  sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Window.)
...
# AOI Question
question14.Question <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Question.=="1")
fixations.Question.Q14 <- sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Question.)
...
# AOI Answer
question14.Answer <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Answer.=="1")
fixations.Answer.Q14 <- sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Answer.)
...
# AOI Legend
question14.Legend <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Legend.=="1")
fixations.Legend.Q14 <- sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Legend.)
...
# AOI Buttons
question14.Buttons <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Buttons.=="1")
fixations.Buttons.Q14 <- sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.Buttons.)
...
# AOI FeatureModel
question14.FM <- question14 %>% filter(AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.FMAOI.=="1")
fixations.FM.Q14 <- sum(question14$AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.FMAOI.)
...
question14.Containing <- question14 %>% 
  filter(  AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.CAOI.5.=="1") 
...
question14.Navigating <- question14 %>% 
  filter(  AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q09.Act14.Snap...Q14.NAOI.4.=="1")
...
participant04.Q15 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q23-Act15-Data.csv", header=TRUE)
attach (participant04.Q15)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q15 <- participant04.Q15 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question15 <- curated04.Q15
...
# AOI Window - QNN for participant question
question15.Window <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Window. =="1")
fixations.Window.Q15 <-  sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Window.)
...
# AOI Question
question15.Question <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Question.=="1")
fixations.Question.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Question.)
...
# AOI Answer
question15.Answer <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Answer.=="1")
fixations.Answer.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Answer.)
...
# AOI Legend
question15.Legend <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Legend.=="1")
fixations.Legend.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Legend.)
...
# AOI Buttons
question15.Buttons <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Buttons.=="1")
fixations.Buttons.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.Buttons.)
...
# AOI FeatureModel
question15.FM <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.FMAOI.=="1")
fixations.FM.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.FMAOI.)
...
question15.Containing <- question15 %>% 
  filter(  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CAOI.7.=="1") 
...
question15.Navigating <- question15 %>% 
  filter(  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.NAOI.6.=="1")
...
# AOI CTC
question15.CTC <- question15 %>% filter(AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CTC.=="1")
fixations.CTC.Q15 <- sum(question15$AOI.hit..P04.TOI.Q23.Act15.Snap...Q15.CTC.)
...
participant04.Q16 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q24-Act16-Data.csv", header=TRUE)
attach (participant04.Q16)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q16 <- participant04.Q16 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question16 <- curated04.Q16
...
# AOI Window - QNN for participant question
question16.Window <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Window. =="1")
fixations.Window.Q16 <-  sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Window.)
...
# AOI Question
question16.Question <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Question.=="1")
fixations.Question.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Question.)
...
# AOI Answer
question16.Answer <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Answer.=="1")
fixations.Answer.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Answer.)
...
# AOI Legend
question16.Legend <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Legend.=="1")
fixations.Legend.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Legend.)
...
# AOI Buttons
question16.Buttons <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Buttons.=="1")
fixations.Buttons.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.Buttons.)
...
# AOI FeatureModel
question16.FM <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.FMAOI.=="1")
fixations.FM.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.FMAOI.)
...
question16.Containing <- question16 %>% 
  filter(  AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CAOI.4.=="1") 
...
# AOI CTC
question16.CTC <- question16 %>% filter(AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CTC.=="1")
fixations.CTC.Q16 <- sum(question16$AOI.hit..P04.TOI.Q24.Act16.Snap...Q16.CTC.)
...
participant04.Q17 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q06-Act17-Data.csv", header=TRUE)
attach (participant04.Q17)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q17 <- participant04.Q17 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question17 <- curated04.Q17
...
# AOI Window - QNN for participant question
question17.Window <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Window. =="1")
fixations.Window.Q17 <-  sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Window.)
...
# AOI Question
question17.Question <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Question.=="1")
fixations.Question.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Question.)
...
# AOI Answer
question17.Answer <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Answer.=="1")
fixations.Answer.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Answer.)
...
# AOI Legend
question17.Legend <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Legend.=="1")
fixations.Legend.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Legend.)
...
# AOI Buttons
question17.Buttons <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Buttons.=="1")
fixations.Buttons.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.Buttons.)
...
# AOI FeatureModel
question17.FM <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.FMAOI.=="1")
fixations.FM.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.FMAOI.)
...
question17.Containing <- question17 %>% 
  filter(  AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CAOI.1.=="1" |	      
  AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CAOI.4.=="1") 
...
# AOI CTC
question17.CTC <- question17 %>% filter(AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CTC.=="1")
fixations.CTC.Q17 <- sum(question17$AOI.hit..P04.TOI.Q06.Act17.Snap...Q17.CTC.)
...
participant04.Q18 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q22-Act18-Data.csv", header=TRUE)
attach (participant04.Q18)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q18 <- participant04.Q18 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question18 <- curated04.Q18
...
# AOI Window - QNN for participant question
question18.Window <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Window. =="1")
fixations.Window.Q18 <-  sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Window.)
...
# AOI Question
question18.Question <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Question.=="1")
fixations.Question.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Question.)
...
# AOI Answer
question18.Answer <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Answer.=="1")
fixations.Answer.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Answer.)
...
# AOI Legend
question18.Legend <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Legend.=="1")
fixations.Legend.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Legend.)
...
# AOI Buttons
question18.Buttons <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Buttons.=="1")
fixations.Buttons.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.Buttons.)
...
# AOI FeatureModel
question18.FM <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.FMAOI.=="1")
fixations.FM.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.FMAOI.)
...
question18.Containing <- question18 %>% 
  filter(  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.CAOI.4.=="1") 
...
question18.Navigating <- question18 %>% 
  filter(  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.NAOI.3.=="1" | 	      
  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.NAOI.5.=="1" | 	      
  AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.NAOI.6.=="1")
...
# AOI CTC
question18.CTC <- question18 %>% filter(AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.CTC.=="1")
fixations.CTC.Q18 <- sum(question18$AOI.hit..P04.TOI.Q22.Act18.Snap...Q18.CTC.)
...
participant04.Q19 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q20-Act19-Data.csv", header=TRUE)
attach (participant04.Q19)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q19 <- participant04.Q19 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question19 <- curated04.Q19
...
# AOI Window - QNN for participant question
question19.Window <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Window. =="1")
fixations.Window.Q19 <-  sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Window.)
...
# AOI Question
question19.Question <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Question.=="1")
fixations.Question.Q19 <- sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Question.)
...
# AOI Answer
question19.Answer <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Answer.=="1")
fixations.Answer.Q19 <- sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Answer.)
...
# AOI Legend
question19.Legend <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Legend.=="1")
fixations.Legend.Q19 <- sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Legend.)
...
# AOI Buttons
question19.Buttons <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Buttons.=="1")
fixations.Buttons.Q19 <- sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.Buttons.)
...
# AOI FeatureModel
question19.FM <- question19 %>% filter(AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.FMAOI.=="1")
fixations.FM.Q19 <- sum(question19$AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.FMAOI.)
...
question19.Containing <- question19 %>% 
  filter(  AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q20.Act19.Snap...Q19.CAOI.1.=="1") 
...
participant04.Q20 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q21-Act20-Data.csv", header=TRUE)
attach (participant04.Q20)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q20 <- participant04.Q20 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question20 <- curated04.Q20
...
# AOI Window - QNN for participant question
question20.Window <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Window. =="1")
fixations.Window.Q20 <-  sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Window.)
...
# AOI Question
question20.Question <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Question.=="1")
fixations.Question.Q20 <- sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Question.)
...
# AOI Answer
question20.Answer <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Answer.=="1")
fixations.Answer.Q20 <- sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Answer.)
...
# AOI Legend
question20.Legend <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Legend.=="1")
fixations.Legend.Q20 <- sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Legend.)
...
# AOI Buttons
question20.Buttons <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Buttons.=="1")
fixations.Buttons.Q20 <- sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.Buttons.)
...
# AOI FeatureModel
question20.FM <- question20 %>% filter(AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.FMAOI.=="1")
fixations.FM.Q20 <- sum(question20$AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.FMAOI.)
...
question20.Containing <- question20 %>% 
  filter(  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.CAOI.6.=="1") 
...
question20.Navigating <- question20 %>% 
  filter(  AOI.hit..P04.TOI.Q21.Act20.Snap...Q20.NAOI.1.=="1")
...
participant04.Q21 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q08-Act21-Data.csv", header=TRUE)
attach (participant04.Q21)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q21 <- participant04.Q21 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question21 <- curated04.Q21
...
# AOI Window - QNN for participant question
question21.Window <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Window. =="1")
fixations.Window.Q21 <-  sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Window.)
...
# AOI Question
question21.Question <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Question.=="1")
fixations.Question.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Question.)
...
# AOI Answer
question21.Answer <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Answer.=="1")
fixations.Answer.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Answer.)
...
# AOI Legend
question21.Legend <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Legend.=="1")
fixations.Legend.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Legend.)
...
# AOI Buttons
question21.Buttons <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Buttons.=="1")
fixations.Buttons.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.Buttons.)
...
# AOI FeatureModel
question21.FM <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.FMAOI.=="1")
fixations.FM.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.FMAOI.)
...
question21.Containing <- question21 %>% 
  filter(  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CAOI.6.=="1" |	      
  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CAOI.7.=="1") 
...
question21.Navigating <- question21 %>% 
  filter(  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.NAOI.3.=="1")
...
# AOI CTC
question21.CTC <- question21 %>% filter(AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CTC.=="1")
fixations.CTC.Q21 <- sum(question21$AOI.hit..P04.TOI.Q08.Act21.Snap...Q21.CTC.)
...
participant04.Q22 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q10-Act22-Data.csv", header=TRUE)
attach (participant04.Q22)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q22 <- participant04.Q22 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question22 <- curated04.Q22
...
# AOI Window - QNN for participant question
question22.Window <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Window. =="1")
fixations.Window.Q22 <-  sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Window.)
...
# AOI Question
question22.Question <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Question.=="1")
fixations.Question.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Question.)
...
# AOI Answer
question22.Answer <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Answer.=="1")
fixations.Answer.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Answer.)
...
# AOI Legend
question22.Legend <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Legend.=="1")
fixations.Legend.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Legend.)
...
# AOI Buttons
question22.Buttons <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Buttons.=="1")
fixations.Buttons.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.Buttons.)
...
# AOI FeatureModel
question22.FM <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.FMAOI.=="1")
fixations.FM.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.FMAOI.)
...
question22.Containing <- question22 %>% 
  filter(  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CAOI.6.=="1" |	      
  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CAOI.4.=="1" |	      
  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CAOI.7.=="1") 
...
question22.Navigating <- question22 %>% 
  filter(  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.NAOI.2.=="1" | 	      
  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.NAOI.5.=="1" | 	      
  AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.NAOI.1.=="1")
...
# AOI CTC
question22.CTC <- question22 %>% filter(AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CTC.=="1")
fixations.CTC.Q22 <- sum(question22$AOI.hit..P04.TOI.Q10.Act22.Snap...Q22.CTC.)
...
participant04.Q23 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q04-Act23-Data.csv", header=TRUE)
attach (participant04.Q23)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q23 <- participant04.Q23 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question23 <- curated04.Q23
...
# AOI Window - QNN for participant question
question23.Window <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Window. =="1")
fixations.Window.Q23 <-  sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Window.)
...
# AOI Question
question23.Question <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Question.=="1")
fixations.Question.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Question.)
...
# AOI Answer
question23.Answer <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Answer.=="1")
fixations.Answer.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Answer.)
...
# AOI Legend
question23.Legend <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Legend.=="1")
fixations.Legend.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Legend.)
...
# AOI Buttons
question23.Buttons <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Buttons.=="1")
fixations.Buttons.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.Buttons.)
...
# AOI FeatureModel
question23.FM <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.FMAOI.=="1")
fixations.FM.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.FMAOI.)
...
question23.Containing <- question23 %>% 
  filter(  AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.CAOI.3.=="1" |	      
  AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.CAOI.5.=="1") 
...
question23.Navigating <- question23 %>% 
  filter(  AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.NAOI.4.=="1")
...
# AOI CTC
question23.CTC <- question23 %>% filter(AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.CTC.=="1")
fixations.CTC.Q23 <- sum(question23$AOI.hit..P04.TOI.Q04.Act23.Snap...Q23.CTC.)
...
participant04.Q24 <- read.csv(file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04-TOI-Q13-Act24-Data.csv", header=TRUE)
attach (participant04.Q24)

# Filters the rows with all NAs, keeps only the fixations of Eye tracker events, and repeated elements
curated04.Q24 <- participant04.Q24 %>% filter(!across(everything(), is.na)) %>% 
  filter(Eye.movement.type=="Fixation" & Sensor=="Eye Tracker") %>% 
  select(Eye.movement.type, Eye.movement.type.index, Gaze.event.duration..ms., Sensor, starts_with("AOI.hit")) %>%
  distinct()


question24 <- curated04.Q24
...
# AOI Window - QNN for participant question
question24.Window <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Window. =="1")
fixations.Window.Q24 <-  sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Window.)
...
# AOI Question
question24.Question <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Question.=="1")
fixations.Question.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Question.)
...
# AOI Answer
question24.Answer <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Answer.=="1")
fixations.Answer.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Answer.)
...
# AOI Legend
question24.Legend <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Legend.=="1")
fixations.Legend.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Legend.)
...
# AOI Buttons
question24.Buttons <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Buttons.=="1")
fixations.Buttons.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.Buttons.)
...
# AOI FeatureModel
question24.FM <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.FMAOI.=="1")
fixations.FM.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.FMAOI.)
...
question24.Containing <- question24 %>% 
  filter(  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.2.=="1" |	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.5.=="1" |	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.6.=="1" |	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.7.=="1" |	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.9.=="1" |	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CAOI.10.=="1") 
...
question24.Navigating <- question24 %>% 
  filter(  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.NAOI.1.=="1" | 	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.NAOI.3.=="1" | 	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.NAOI.4.=="1" | 	      
  AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.NAOI.8.=="1")
...
# AOI CTC
question24.CTC <- question24 %>% filter(AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CTC.=="1")
fixations.CTC.Q24 <- sum(question24$AOI.hit..P04.TOI.Q13.Act24.Snap...Q24.CTC.)
...
write.csv(allQuestions.data.frame,file = "../../Experiment-Data/Eye-tracking-data-samples/PartP04/P04.csv", row.names = FALSE)
