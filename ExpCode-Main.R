...
FMs_Q1_Med_1
set.seed(2)
sample.Q1_Med_1 <- FMs_Q1_Med_1[sample(1:nrow(FMs_Q1_Med.1), 2),]
sample.Q1_Med_1
...
FMs_Q1_Med_2
set.seed(2)
sample.Q1_Med_2 <- FMs_Q1_Med_2[sample(1:nrow(FMs_Q1_Med.2), 2),]
sample.Q1_Med_2
...
FMs_Q1_Med_3
set.seed(3)
sample.Q1_Med_3 <- FMs_Q1_Med_3[sample(1:nrow(FMs_Q1_Med.3), 2),]
sample.Q1_Med_3
...
FMs_Med_Q3_1
set.seed(2)
sample.Med_Q3_1 <- FMs_Med_Q3_1[sample(1:nrow(FMs_Med_Q3.1), 2),]
sample.Med_Q3_1
...
FMs_Med_Q3_2
set.seed(2)
sample.Med_Q3_2 <- FMs_Med_Q3_2[sample(1:nrow(FMs_Med_Q3.2), 2),]
sample.Med_Q3_2
...
FMs_Med_Q3_3
set.seed(2)
sample.Med_Q3_3 <- FMs_Med_Q3_3[sample(1:nrow(FMs_Med_Q3.3), 2),]
sample.Med_Q3_3
...
FMs_Q3_Bigger.1
set.seed(2)
sample.Q3_bigger_1 <- FMs_Q3_Bigger_1[sample(1:nrow(FMs_Q3_Bigger.1), 2),]
sample.Q3_bigger_1
...
FMs_Q3_Bigger_2
set.seed(2)
sample.Q3_bigger_2 <- FMs_Q3_Bigger_2[sample(1:nrow(FMs_Q3_Bigger.2), 2),]
sample.Q3_bigger_2
#write.csv(sample.Q3_bigger.2,"your directory path\\file-Name.csv", row.names = TRUE)
   
          #..............................................................#        

FMs_Q3_Bigger.3 <- ExpData %>% filter(NoF>=array[4, 1], NoC>=array[3, 2] & NoC<array[4, 2])
FMs_Q3_Bigger.3
set.seed(3)
