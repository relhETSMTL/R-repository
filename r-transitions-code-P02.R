...
curated02.Q01 <- participant02.Q01 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Answer=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.Buttons.) %>% 
  rename(FM=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q17.Act01.Snap...Q01.Window.) %>%
  filter(Window=="1") %>%
...
curated02.Q01$CTC <- rep(0,nrow(curated02.Q01))
curated02.Q01 <- curated02.Q01 %>% relocate(CTC, .before = FM)
...
curated02.Q02 <- participant02.Q02 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.Buttons.) %>% 
#  rename(CTC=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q06.Act02.Snap...Q02.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)

  curated02.Q02$CTC <- rep(0,nrow(curated02.Q02))
  curated02.Q02 <- curated02.Q02 %>% relocate(CTC, .before = FM)
...
curated02.Q03 <- participant02.Q03 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q22.Act03.Snap...Q03.Window.) %>%
  filter(Window=="1") %>%
...
curated02.Q04 <- participant02.Q04 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q03.Act04.Snap...Q04.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q05 <- participant02.Q05 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q20.Act05.Snap...Q05.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q06 <- participant02.Q06 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q23.Act06.Snap...Q06.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q07 <- participant02.Q07 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.Buttons.) %>% 
#  rename(CTC=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q02.Act07.Snap...Q07.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q07$CTC <- rep(0,nrow(curated02.Q07))
curated02.Q07 <- curated02.Q07 %>% relocate(CTC, .before = FM)
...
curated02.Q08 <- participant02.Q08 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.Buttons.) %>% 
# rename(CTC=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q18.Act08.Snap...Q08.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q08$CTC <- rep(0,nrow(curated02.Q08))
curated02.Q08 <- curated02.Q08 %>% relocate(CTC, .before = FM)
...
curated02.Q09 <- participant02.Q09 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q16.Act09.Snap...Q09.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q10 <- participant02.Q10 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q21.Act10.Snap...Q10.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q11 <- participant02.Q11 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q14.Act11.Snap...Q11.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q12 <- participant02.Q12 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q15.Act12.Snap...Q12.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q13 <- participant02.Q13 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.Buttons.) %>% 
  # rename(CTC=AOI.hit..P02.TOI.Q13.Act13.Snap...Q08.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q13.Act13.Snap...Q13.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q13$CTC <- rep(0,nrow(curated02.Q13))
curated02.Q13 <- curated02.Q13 %>% relocate(CTC, .before = FM)
...
curated02.Q14 <- participant02.Q14 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.Buttons.) %>% 
  # rename(CTC=AOI.hit..P02.TOI.Q05.Act14.Snap...Q08.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q05.Act14.Snap...Q14.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q14$CTC <- rep(0,nrow(curated02.Q14))
curated02.Q14 <- curated02.Q14 %>% relocate(CTC, .before = FM)
...
curated02.Q15 <- participant02.Q15 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q08.Act15.Snap...Q15.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q16 <- participant02.Q16 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q07.Act16.Snap...Q16.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q17 <- participant02.Q17 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q24.Act17.Snap...Q17.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q18 <- participant02.Q18 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q12.Act18.Snap...Q18.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q19 <- participant02.Q19 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.Buttons.) %>% 
  # rename(CTC=AOI.hit..P02.TOI.Q01.Act19.Snap...Q08.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q01.Act19.Snap...Q19.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q19$CTC <- rep(0,nrow(curated02.Q19))
curated02.Q19 <- curated02.Q19 %>% relocate(CTC, .before = FM)
...
curated02.Q20 <- participant02.Q20 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.Buttons.) %>% 
  # rename(CTC=AOI.hit..P02.TOI.Q04.Act20.Snap...Q08.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q04.Act20.Snap...Q20.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,FM,Legend,Question,Window)


# If the question lacks CTCs, add the default empty CTC and put it after Buttons
curated02.Q20$CTC <- rep(0,nrow(curated02.Q20))
curated02.Q20 <- curated02.Q20 %>% relocate(CTC, .before = FM)
...
curated02.Q21 <- participant02.Q21 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q09.Act21.Snap...Q21.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q22 <- participant02.Q22 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q11.Act22.Snap...Q22.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q23 <- participant02.Q23 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q10.Act23.Snap...Q23.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
curated02.Q24 <- participant02.Q24 %>% filter(!across(everything(), is.na)) %>% 
  ...
  rename(Index=Eye.movement.type.index) %>%
  rename(Duration=Gaze.event.duration..ms.) %>%
  rename(Answer=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.Answer.) %>%
  rename(Buttons=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.Buttons.) %>% 
  rename(CTC=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.CTC.) %>%  
  rename(FM=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.FMAOI.) %>%
  rename(Legend=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.Legend.) %>% 
  rename(Question=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.Question.) %>%
  rename(Window=AOI.hit..P02.TOI.Q19.Act24.Snap...Q24.Window.) %>%
  filter(Window=="1") %>%
  select(Index,Duration,Answer,Buttons,CTC,FM,Legend,Question,Window)
...
participant02.all.questions <- rbind(question01, question02, question03, question04, question05,
                                     question06, question07, question08, question09, question10,
                                     question11, question12, question13, question14, question15,
                                     question16, question17, question18, question19, question20,
                                     question21, question22, question23, question24)

write.csv(participant02.all.questions,
          file = "../../Experiment-Data/Eye-tracking-data-samples/PartP02/P02-Transitions-Data.csv", 
          row.names = FALSE)
