...
question15.Containing <- question15 %>% 
  filter(  AOI.hit..P03.TOI.Q09.Act15.Snap...Q15.CAOI.3.=="1" |	      
...
question15.Navigating <- question15 %>% 
  filter(  AOI.hit..P03.TOI.Q09.Act15.Snap...Q15.NAOI.1.=="1" | 	      
  AOI.hit..P03.TOI.Q09.Act15.Snap...Q15.NAOI.2.=="1" | 	      
...
question19.Containing <- question19 %>% 
  ...
  AOI.hit..P03.TOI.Q13.Act19.Snap...Q19.CAOI.2.=="1" |	      
